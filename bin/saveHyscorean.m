...
if getpref('hyscorean','reportlicense')
    ...
    if isfield(handles.Data,'BrukerParameters')
        ...
        reportdata.Pulse90Length = Param.Pulse90*1000;
        reportdata.Pulse180Length = Param.Pulse180*1000;
        reportdata.ShotRepTime = Param.ShotRepTime;
        reportdata.ShotsPerLoop = Param.ShotsPerLoop;
